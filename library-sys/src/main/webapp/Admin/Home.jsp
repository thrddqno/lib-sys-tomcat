    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush my-3">
                <a href="<%=request.getContextPath()%>/admin/home.jsp" class="list-group-item list-group-item-action bg-transparent second-text active"><i class="fas fa-chart-line me-2"></i>Dashboard</a>
                <a href="<%=request.getContextPath()%>/admin/books?page=1" class="list-group-item list-group-item-action bg-transparent second-text fw-bold"><i class="fas fa-book-open me-2"></i>Books</a>
